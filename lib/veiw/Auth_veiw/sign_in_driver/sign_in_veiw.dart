...
class SignInDdiverView extends GetWidget<AuthDriverVeiwModel> {
  SignInDdiverView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    Get.put(AuthDriverVeiwModel());
    return Scaffold(
      body: SafeArea(
        child: GetBuilder<AuthDriverVeiwModel>(
